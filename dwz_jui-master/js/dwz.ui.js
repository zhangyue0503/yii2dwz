...
function initUI($p){
	...
	//kindeditor
	//zhangyue
	//kindeditorjspath,kindeditorcreate都在zyblog\dwz\widget\views\kindeditor.php中,dwz.min.js中已经加入
	//参考：搜索引擎搜索关键词【dwz kindeditor】
	$("textarea.kindeditor", $p).each(function(){$.getScript(kindeditorjspath,kindeditorcreate)});
		if ($.fn.uploadify) {
